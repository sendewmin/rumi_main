...
const mockReports = [
  {
    id: 1,
    listingTitle: 'Cheap Room — Wellawatte',
    landlord: 'Ruwan Gayan',
    reportCount: 5,
    reason: 'Misleading photos — actual room looks completely different',
    reportedBy: 'Amali Fernando',
    date: 'Mar 20, 2026',
  },
  {
    id: 2,
    listingTitle: 'Boarding Room — Dehiwala',
    landlord: 'Unknown Landlord',
    reportCount: 3,
    reason: 'Potential scam — landlord asked for large deposit upfront and disappeared',
...
const recentActivity = [
  { id: 1, text: 'New listing submitted by Kasun Perera — Colombo 7',    time: '2 min ago',  color: 'blue' },
  { id: 2, text: 'User Nimal Silva was banned by Admin',                   time: '1 hr ago',   color: 'red' },
  { id: 3, text: 'Listing "Annex — Galle" was approved',                   time: '3 hr ago',   color: 'green' },
  { id: 4, text: 'New report filed on "Cheap Room — Wellawatte"',          time: '5 hr ago',   color: 'amber' },
    ...
    <div className="ad-approval-body">
      <div className="ad-approval-top">
        <div>
          ...
          <p className="ad-approval-sub">📍 {listing.location} · by {listing.landlord}</p>
      ...
      <div className="ad-approval-footer">
        ...
        <div className="ad-approval-actions">
          <button className="ad-btn ad-btn-approve" onClick={() => onApprove(listing.id)}>✓ Approve</button>
          <button className="ad-btn ad-btn-reject"  onClick={() => onReject(listing.id)}>✕ Reject</button>
        </div>
      </div>
    </div>
  </div>
            ...
            <div>
              ...
              {pendingListings.length > 0 ? (
                ...
                <div className="ad-empty">
                  ...
                  <p className="ad-empty-text">No pending approvals — all caught up!</p>
                </div>
              )}
            </div>
          )}
          ...
          {activeTab === 'reports' && (
            <div>
              ...
              {reports.length > 0 ? (
                ...
                <div className="ad-empty">
                  <div className="ad-empty-icon">✅</div>
                  <p className="ad-empty-text">No active reports — platform is clean!</p>
                </div>
              )}
            </div>
          )}
